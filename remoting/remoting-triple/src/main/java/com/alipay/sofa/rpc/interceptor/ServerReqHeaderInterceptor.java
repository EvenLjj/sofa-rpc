    ...
    public <ReqT, RespT> ServerCall.Listener<ReqT> interceptCall(final ServerCall<ReqT, RespT> call,
        ...
        try {
                ...
                public void close(Status status, Metadata trailers) {
                    try {
                        ...
                        if (!status.isOk()) {
                            ...
                            TripleTracerAdapter.serverSend(sofaRequest, requestHeaders, ctxWithSpan, sofaResponse,
                                cause);
                        }
                    }
            ...
            try {
                ...
                TripleTracerAdapter.serverSend(sofaRequest, requestHeaders, ctxWithSpan, sofaResponse, t);
            ...
            return new ForwardingServerCallListener.SimpleForwardingServerCallListener<ReqT>(
                ...
                public void onComplete() {
                    try {
                        ...
                        TripleTracerAdapter.serverSend(sofaRequest, requestHeaders, ctxWithSpan, sofaResponse, null);
                    }
                }
